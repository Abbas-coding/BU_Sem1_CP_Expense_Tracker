...
//	cout << "-------------------------------------------------------------\n";
//
//	for (size_t i = 0; i < categoryExpenses.size(); ++i) {
...
//	if (expenseIndex < 1 || expenseIndex > static_cast<int>(categoryExpenses.size())) {
...
//	int currentIndex = 1;
//	for (const auto& expense : expenses) {
//		if (!(expense.category == category && currentIndex == expenseIndex)) {
